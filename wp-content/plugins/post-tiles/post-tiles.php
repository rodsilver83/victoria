...
function tc_post_tiles($atts, $content=null)
{
	...
	// EXAMPLE USAGE: [post-tiles categories="1,2,3,4" posts="8"]
	   ...
	   $the_query = $posts_query.$cat_query.'&paged='.$paged.'&orderby=rand' ;
	   ...
	   if ($pagination_key == "top" || $pagination_key == "both" || $pagination_key == "bottom") {
               ...
               if ( $current_page == 1 ){
                   $pagination = '
                   <span class="page-numbers current prev-page">&nbsp;</span>
                   <a class="page-numbers next-page" href="http://www.victoria147.org/page/2">&nbsp;</a>
                ';
               }else{
                   $pagination = '
                   <a class="page-numbers prev-page" href="http://www.victoria147.org/page/1">&nbsp;</a>
                   <span class="page-numbers current next-page">&nbsp;</span>
                ';
               }
	   ...
	   if (have_posts()) : while (have_posts()) : the_post();
		  ...
		  $thumbnail_biography = get_field('thumbnail_biography');
		  $title_biography = get_field( 'title_biography' );

		  $image_size = getimagesize( $thumbnail_biography ); 
		  ...
		  if ($featured_images_key == "true") {
		      if ( has_post_thumbnail()) {
			      ...
			      $url = $thumb['0'];				  
			      $featured_style = "style='background: url(".$thumbnail_biography.") 0 0;' class='featured-image ".$animation_style." ".$cat_var."'";
		      } else {
		  ...
		  $output .= "<li ".$featured_style." id='".$theID."'><a href='$temp_link' class='".$cat_var."'><div class='see_more'><h4>$temp_title <span class='ico'></span></h4><p>$title_biography</p></div></a></li>\n";
