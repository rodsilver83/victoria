jQuery(document).ready(function($){
	...
	setTimeout(function(){
		...
		if($('.posttiles-pagination a.next-page').length > 0){
			
			//alert("next");
			window.location = $('.posttiles-pagination a.next-page').attr('href');



		}else if($('.posttiles-pagination a.prev-page').length > 0){
			//alert("prev");
			window.location = $('.posttiles-pagination a.prev-page').attr('href');
		}
