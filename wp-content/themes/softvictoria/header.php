...
<div id="main-menu" class=" non-transparent-h fixed">
 <nav class="top-bar transparent-h p-menu-fixed" data-topbar="" role="navigation" data-options="sticky_on: large">
   ...
   <li class="name">
     <a href="/">
     	<img src="<?php bloginfo('template_directory'); ?>/img/logo/logo-victoria147.png" alt="Victoria 147">
     </a>
   </li>
   ...
   <ul class="left">
     ...
     <li class="has-dropdown not-click">
       ...
       <ul class="dropdown the-submenu-top p-submenu-fixed"><li class="title back js-generated"><h5><a href="javascript:void(0)">Back</a></h5></li><li class="parent-link show-for-small"><a class="parent-link js-generated" href="#">Emprendedora Victoria147</a></li>
						...
						?>
         <li><a href="<?php /* print $linkEmprendedoras*/ print("/category/red-de-emprendedoras")?>" class="the-submenu-item submenu-colored bordered-submenu">Red de Emprendedoras</a></li>
					...
					?>
         <li><a href="<?php echo $linkFellows?>" class="the-submenu-item submenu-colored bordered-submenu">Red de Fellows</a></li>
         ...
         <li><a href="/academia-147" class="the-submenu-item submenu-colored bordered-submenu">Academia Victoria147</a></li>
       </ul>
     </li>
     <li class="has-dropdown not-click">
     	...
     	<ul class="dropdown the-submenu-top p-submenu-fixed"><li class="title back js-generated"><h5><a href="javascript:void(0)">Back</a></h5></li><li class="parent-link show-for-small"><a class="parent-link js-generated" href="#">Mujer Victoria147</a></li>
				...
				?>
         <li><a href="<?php echo $linkDescargables;?>" class="the-submenu-item submenu-colored bordered-submenu">Descargables</a></li>
					...
					?>
         <li><a href="<?php echo $linkVideos?>" class="the-submenu-item submenu-colored bordered-submenu">Videos</a></li>
       </ul>
     </li>
     <li class="has-dropdown not-click">
     	<a href="http://www.v147.mx/" target="_blank" class="the-menu-top double-lined-menu menu-color">Productos V147</a>
         ...
         <li><a href="http://www.v147.mx/" target="_blank" class="the-submenu-item submenu-colored bordered-submenu">Balance</a></li>
         <li><a href="http://www.v147.mx/" target="_blank" class="the-submenu-item submenu-colored bordered-submenu">Performance</a></li>
         <li><a href="http://www.v147.mx/" target="_blank" class="the-submenu-item submenu-colored bordered-submenu">Imagen</a></li>
         <li><a href="http://www.v147.mx/" target="_blank" class="the-submenu-item submenu-colored bordered-submenu">Placer por placer</a></li>
       </ul>
     </li>
     <li>
